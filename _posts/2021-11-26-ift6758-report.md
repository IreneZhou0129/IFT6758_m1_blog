...
<br />
![screenshot](assets/milestone2/q2/q2_1)
<br />
...
<br />
![screenshot](assets/milestone2/q2/q2_1_angle)
<br />
...
<br />2.1 2D Histogram:
<br />
![screenshot](assets/milestone2/q2/q2_1_2d)
<br />
...
<br />
![screenshot](assets/milestone2/q2/q2_2)
<br />
...
<br />
![screenshot](assets/milestone2/q2/q2_2_angle)
<br />
...
<br />
### 3
<br />2.3 Goals only, binned by distance, separated by empty net and non-empty net events:
<br />
![screenshot](assets/milestone2/q2/q2_3)
<br />
...
<br /><br />
### 4
<br />Logistic Regression, trained on `distance` only: [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=logreg-distance&version=1.0.0)
<br />
<br />Logistic Regression, trained on `angle` only: [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=logreg-model&version=1.0.0)
<br />
<br />Logistic Regression, trained on both `distance` and `angle`: [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=logreg-both&version=1.0.0)
<br />

## Question 4
### 5
<br />[comet link](https://www.comet.ml/xiaoxin-zhou/milestone-2/15735671003347eb85b6cecf084cd091?assetId=cb8f1f34b00146fface3c935ef0738a0&assetPath=dataframes&experiment-tab=assets)


#NOTE the csv is saved in /assets/milestone2

<br />The list of all of the features:<br />
...
### 1
<br />
![screenshot](assets/milestone2/q5/5-1-roc.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-1-goal.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-1-cumulative.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-1-calibration.png)
<br />
<br /> distance-only: [comet link](https://www.comet.ml/xiaoxin-zhou/milestone-2/0e337206a3734267b1762bfd3196897c?experiment-tab=assets)
<br />
<br /> angle-only: [comet link](https://www.comet.ml/xiaoxin-zhou/milestone-2/efa3da829f08400d817337e0292d0e83?experiment-tab=assets)
<br />
<br /> distance and angle: [comet link](https://www.comet.ml/xiaoxin-zhou/milestone-2/efdcddf670d14158856c43cbd58606aa?experiment-tab=assets)
...
### 2
<br />
![screenshot](assets/milestone2/q5/5-2-roc.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-2-goal.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-2-cumulative.png)
<br />
<br />
![screenshot](assets/milestone2/q5/5-2-calibration.png)
<br /><br />
...
<br /><br />
<br />[comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=xgboost-model-q5-2-tuned&version=1.0.0)
<br />
### 3
<br />
...
- [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=xgboost-model-var-threshold&version=1.0.0)
...
- [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=xgboost-model-selectkbest&version=1.0.1)
...
- [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=xgboost-model-rfe&version=1.0.0)
...
- [comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=xgboost-model-extratree&version=1.0.0)
...
<br />ROC
<br />
![screenshot](assets/milestone2/q6/q6_2_a1.png)
<br />
<br />Goal
<br />
![screenshot](assets/milestone2/q6/q6_2_a1_goal.png)
<br />
<br />Cumulative
<br />
![screenshot](assets/milestone2/q6/q6_2_a1_cumulative.png)
<br />
<br />Calibration
<br />
![screenshot](assets/milestone2/q6/q6_2_a1_calibration.png)
<br />
...
<br />ROC
<br />
![screenshot](assets/milestone2/q6/q6_2_a2.png)
<br />
<br />Goal
<br />
![screenshot](assets/milestone2/q6/q6_2_a2_goal.png)
<br />
<br />Cumulative
<br />
![screenshot](assets/milestone2/q6/q6_2_a2_cumulative.png)
<br />
<br />Calibration
<br />
![screenshot](assets/milestone2/q6/q6_2_a2_calibration.png)
<br />
#### Approach 3: More advanced feature selection strategy: Decision Tree Classifier with PCA feature reduction
<br />We used PCA to reduce the features to 3. We got a validation accuracy of 82.86% using the Decision Tree Model after.
<br />ROC
<br />
![screenshot](assets/milestone2/q6/q6_2_a3.png)
<br />
<br />Goal
<br />
![screenshot](assets/milestone2/q6/q6_2_a3_goal.png)
<br />
<br />Cumulative
<br />
![screenshot](assets/milestone2/q6/q6_2_a3_cumulative.png)
<br />
<br />Calibration
<br />
![screenshot](assets/milestone2/q6/q6_2_a3_calibration.png)
<br />
#### Approach 4: Approach 4: Different model type: Multilayer Perceptron Classifier
<br />The Multilayer Perceptron classifier is a type of feedforward artificial neural network. We got a validation accuracy of 90.82% and AUC of 0.5.
<br />ROC
<br />
![screenshot](assets/milestone2/q6/q6_2_a4.png)
<br />
<br />Goal
<br />
![screenshot](assets/milestone2/q6/q6_2_a4_goal.png)
<br />
<br />Cumulative
<br />
![screenshot](assets/milestone2/q6/q6_2_a4_cumulative.png)
<br />
<br />Calibration
<br />
![screenshot](assets/milestone2/q6/q6_2_a4_calibration.png)
<br />
<br />Summary<br />
...
### 2 Models links
#### Approach 1
[comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=decision-tree&version=1.0.4)
#### Approach 2
[comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=decision-tree&version=1.0.3)
#### Approach 3
[comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=decision-tree&version=1.0.2)
#### Approach 4
[comet link](https://www.comet.ml/api/rest/v2/registry-model/item/download?workspaceName=xiaoxin-zhou&modelName=mlp&version=1.0.0)

## Question 7
### 1 - Regular Seasons
<br />For the Logistic regression models trained on [distance from net], [angle from net], and [distance and angle from net], testing on the untouched 2019/20 regular season dataset yielded 0.01 better AUC of 0.68, 0.51, and 0.68, respectively, compared to the training set’s validation AUC of 0.67, 0.50, and 0.67, respectively. The best XGBoost model saved in part 5 achieved a AUC value of 0.7 for this test set. The AUC for the test set here (0.54) is a lot worse than the AUC from the validation set tested earlier. The best overall model from part 6 (MLP) achieved an AUC value of 0.50 for this test set. It is the same result compared with the AUC from the validation set tested earlier (0.50), which is normal to see, but a terrible result.
...
<br />ROC
<br />
![screenshot](assets/milestone2/q7/part7-q1-roc.png)
<br />

<br />Goal
<br />
![screenshot](assets/milestone2/q7/part7-q1-goal.png)
<br />

<br />Cumulative
<br />
![screenshot](assets/milestone2/q7/part7-q1-cumulative.png)
<br />

<br />Calibration
<br />
![screenshot](assets/milestone2/q7/part7-q1-calibration.png)
<br />
...
<br />ROC
<br />
![screenshot](assets/milestone2/q7/part7-q2-roc.png)
<br />

<br />Goal
<br />
![screenshot](assets/milestone2/q7/part7-q2-goal.png)
<br />

<br />Cumulative
<br />
![screenshot](assets/milestone2/q7/part7-q2-cumulative.png)
<br />

<br />Calibration
<br />
![screenshot](assets/milestone2/q7/part7-q2-calibration.png)
<br />